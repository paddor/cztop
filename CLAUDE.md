...
- `lib/cztop/socket/readable.rb` — `Readable` mixin: `#receive`, `#wait_readable`, `#read_timeout`
- `lib/cztop/socket/writable.rb` — `Writable` mixin: `#send`, `#<<`, `#wait_writable`, `#write_timeout`
